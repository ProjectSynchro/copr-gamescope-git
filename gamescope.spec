%global commit f2444c1269f75c21f37623559998f49f2a561384
%global shortcommit %(c=%{commit}; echo ${c:0:7})
%global git_date 20240730T215109Z
%global tag 3.14.25
...
BuildRequires:  (pkgconfig(libliftoff) >= 0.4.1 with pkgconfig(libliftoff) < 0.6)
